...
def categorize_dish(dish_name, dish_ingredients):
    ...
    if set(VEGAN).issuperset(set(dish_ingredients)):
        return dish_name + ": VEGAN"
    elif set(VEGETARIAN).issuperset(set(dish_ingredients)):
        return dish_name + ": VEGETARIAN"
    elif set(PALEO).issuperset(set(dish_ingredients)):
        return dish_name + ": PALEO"
    elif set(KETO).issuperset(set(dish_ingredients)):
        return dish_name + ": KETO"
    elif set(OMNIVORE).issuperset(set(dish_ingredients)):
...
def singleton_ingredients(dishes, intersection):
    ...
    for dish in dishes:
        singleton_ingredients = singleton_ingredients.union(dish - intersection)
